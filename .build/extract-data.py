...
try:
    r = subprocess.run(['docker','exec','mariadb','mariadb','-u','Minecraft','-p***REMOVED***','XConomy','-N','-e',
...
try:
    r = subprocess.run(['docker','exec','mariadb','mariadb','-u','Minecraft','-p***REMOVED***','HuskTowns','-N','-e',
